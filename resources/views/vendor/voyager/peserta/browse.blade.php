...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
            <a href="{{ route('voyager.'.$dataType->slug.'.import').'?id='.request()->id }}" class="btn btn-primary btn-add-new">
                <i class="voyager-upload"></i> <span>Bulk Import</span>
            </a>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
            $(".breadcrumb li:eq(0) a").html('<i class="voyager-boat"></i> Pelatihan').attr("href", "{{ route('voyager.pelatihan.index') }}")
