    ...
    public function search()
    {
        ...
        if ($certificates->isEmpty()) {
            ...
            foreach ($certificates as $certificate) {
                $url = (empty($certificate->sertifikat)) ? "" : '<a href="' . Storage::disk(config('voyager.storage.disk'))->url(json_decode($certificate->sertifikat)[0]->download_link) . '" class="view" title="" data-toggle="tooltip" data-original-title="View">
